package com.ardianhilmip.retrovolley.retrofit.adapter;
...
import com.ardianhilmip.retrovolley.retrofit.activity.UpdateActivity;
import com.ardianhilmip.retrovolley.retrofit.model.DataModel;
...
public class AdapterData extends RecyclerView.Adapter<AdapterData.HolderData> {
    ...
    public HolderData onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View layout = LayoutInflater.from(parent.getContext()).inflate(R.layout.list_karyawan, parent, false);
        ...
        private void getData() {
            ...
            ambilData.enqueue(new Callback<ResponseModel>() {
                ...
                public void onResponse(Call<ResponseModel> call, Response<ResponseModel> response) {
                    ...
                    String varJabatan = listData.get(0).getJabatan();
                    ...
                    kirim.putExtra("id_jabatan", varNama);
